...
JAZZMIN_SETTINGS = {
    ...
    "search_model": ["app.Project", "app.Skill", "app.Blog"],
    "user_avatar": None,
    "topmenu_links": [
    ...
    "hide_apps": [],
    "hide_models": ["app.Feature", "app.Learning", "app.ProjectImage", "auth.Group"],
    ...
    "icons": {
        ...
        "app.Skill": "fas fa-bolt",
        "app.Project": "fas fa-laptop-code",
        "app.Experience": "fas fa-briefcase",
        "app.Blog": "fas fa-newspaper",
        "app.FAQ": "fas fa-question-circle",
        "app.Resume": "fas fa-file-pdf",
